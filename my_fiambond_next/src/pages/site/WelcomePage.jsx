        ...
        <div className="flex flex-col min-h-screen font-sans bg-gray-50 text-gray-900 w-full overflow-x-hidden">
            ...
            <header className="hero-section relative w-full pt-28 pb-16 lg:pt-36 lg:pb-32 overflow-hidden bg-gradient-to-b from-indigo-50/50 via-white to-white">
                ...
                <div className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 grid md:grid-cols-2 gap-10 lg:gap-20 items-center relative z-10">
                    ...
                    {/* Text Side */}
                    <div className="hero-text text-center md:text-left text-left">
                ...
                <div className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8">
                   <div className="text-center mb-16 max-w-2xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div className="relative p-8 rounded-3xl bg-gray-50 border border-gray-100 hover:border-indigo-100 hover:shadow-xl transition-all duration-300 group text-left">
            ...
            <section id="pricing" className="py-20 md:py-24 bg-slate-900 text-white relative overflow-hidden scroll-mt-24 w-full">
                ...
                <div className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                     ...
                     <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
                         {/* PERSONAL (FREE) */}
                         <div className="bg-slate-800/50 backdrop-blur-md rounded-3xl p-6 md:p-8 border border-slate-700 hover:border-slate-600 transition-all hover:transform hover:-translate-y-2 duration-300 flex flex-col h-full text-left">
                        ...
                        {/* FAMILY */}
                        <div className="bg-white text-gray-900 rounded-3xl p-6 md:p-8 border-4 border-indigo-600 relative flex flex-col shadow-2xl transform md:scale-105 md:-translate-y-4 z-10 text-left">
                        ...
                        <div className="bg-slate-800/50 backdrop-blur-md rounded-3xl p-6 md:p-8 border border-slate-700 hover:border-slate-600 transition-all hover:transform hover:-translate-y-2 duration-300 flex flex-col h-full text-left">
                            ...
                            <Link href="/register?realm=company" className="secondary-btn w-full mb-4 bg-slate-700 text-white border-none hover:bg-slate-600 py-3 rounded-xl text-center">
                                Sign Up / Log In to Request Access
                            </Link>
