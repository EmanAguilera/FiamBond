...
// Paths adjusted based on your architecture: src/pages/auth/Login.tsx -> ../../config
...
export default function Login() {
  ...
  async function handleLoginSubmit(e: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      // Redirect to the general realm entry point
      router.push("/realm"); 
    } catch (error: any) {
    ...
    <main className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
      <div className="w-full max-w-md bg-white p-8 rounded-2xl shadow-xl">
        ...
        <button 
          ...
          type="button"
          className="w-full mb-6 flex items-center justify-center gap-2 border border-gray-300 py-3 rounded-lg hover:bg-gray-50 font-semibold text-gray-700 transition-colors shadow-sm disabled:opacity-50"
          disabled={!auth}
        > 
