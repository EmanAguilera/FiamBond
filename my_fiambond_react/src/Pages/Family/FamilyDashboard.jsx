...
const FamilyReportChartWidget = lazy(() => import('../../Components/Family/Dashboard/FamilyReportChartWidget.jsx'));
const LoanTrackingWidget = lazy(() => import('../../Components/Personal/Loan/LoanTrackingWidget.js'));
const GoalListsWidget = lazy(() => import("../../Components/Personal/Goal/GoalListsWidget.jsx"));
const CreateLoanWidget = lazy(() => import('../../Components/Personal/Loan/CreateLoanWidget.js'));
const CreateFamilyTransactionWidget = lazy(() => import('../../Components/Family/Transaction/CreateFamilyTransactionWidget.js'));
const CreateFamilyGoalWidget = lazy(() => import('../../Components/Family/Goal/CreateFamilyGoalWidget.js'));
const FamilyTransactionsWidget = lazy(() => import('../../Components/Family/Transaction/FamilyTransactionsWidget.js'));
const FamilyMembersView = lazy(() => import('../../Components/Family/Management/FamilyMembersView.jsx'));
