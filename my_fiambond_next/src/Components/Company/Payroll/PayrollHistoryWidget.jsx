...
export default function PayrollHistoryWidget({ transactions, companyName }) {
    ...
    const payrollData = useMemo(() => {
        ...
        return transactions
            ...
            .filter(tx => {
                // Ensure tx.created_at is a Date object (handling the shimmed toDate() function)
    ...
    const handleGeneratePDF = (e) => {
        e.preventDefault();
        // ⭐️ Next.js consideration: Use relative path for logo, accessed via window.location.origin
