...
export default function CompanyPayrollWidget({ company, members, onSuccess }) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Optional: If Cash Advance, you might want to create a Loan record here too 
            // (omitted for brevity, but fits the business suite logic)

            if (onSuccess) onSuccess();
            setFormData({ employeeId: '', amount: '', notes: '' });
            alert(`${typeLabel} recorded successfully.`);
