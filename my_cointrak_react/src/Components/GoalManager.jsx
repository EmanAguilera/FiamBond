...
import { AppContext } from "../Context/AppContext"; // Adjust the path based on your folder structure
...
export default function GoalManager() {
  ...
  // Fetches a specific page of ACTIVE goals
  ...
  // Fetches a specific page of COMPLETED goals
  ...
  return (
    // Note: No outer wrapper or title, making it a flexible, embeddable component.
