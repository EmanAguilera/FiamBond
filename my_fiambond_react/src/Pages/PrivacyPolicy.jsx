...
export default function PrivacyPolicy() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8 font-sans text-gray-900">
      <Helmet>
        <title>Privacy Policy | FiamBond</title>
      </Helmet>
        ...
        <div className="bg-white rounded-3xl shadow-xl p-8 md:p-12 border border-gray-100">
          ...
          <div className="space-y-8 text-gray-600 leading-relaxed">
            ...
            <section>
              ...
              <p>
                If you have questions about this Privacy Policy, please contact us at <span className="text-indigo-600 font-medium">support@fiambond.web.app</span>.
              </p>
            </section>
