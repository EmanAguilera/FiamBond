                        ...
                        {user && (
                            <div className="hidden md:block relative" ref={dropdownRef}>
                                ...
                                {isProfileMenuOpen && (
                                    /* 
                                       FIX: 
                                       - Changed 'w-48' to 'min-w-full' to stretch to parent width (Name + Avatar).
                                       - Added 'whitespace-nowrap' to prevent breaking on short names.
                                    */
                                    <div className="absolute right-0 mt-2 min-w-full bg-white rounded-lg shadow-xl border border-gray-100 py-2 animate-fade-in-down origin-top-right z-50">
                                        <Link 
                                            to="/settings" 
