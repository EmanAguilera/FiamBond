...
const CreateLoanWidget = dynamic(() => import('../../Components/Personal/Loan/Setup/CreateLoanWidget'), { ssr: false });
const CreateFamilyTransactionWidget = dynamic(() => import('../../Components/Family/Finance/CreateFamilyTransactionWidget'), { ssr: false });
const CreateFamilyGoalWidget = dynamic(() => import('../../Components/Family/Goal/CreateFamilyGoalWidget'), { ssr: false });
