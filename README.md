...
Figure 1: The Fiambond Opening display the application's introduction, featuring well-known action buttons, such as login and register, same approach to the top side-bar that directly to the authentication process, and the FiamBond name redirects the user to this opening screen.

<img width="1853" height="915" alt="image" src="https://github.com/user-attachments/assets/978c0401-8dd4-457a-b8cf-f2429a759d2d" />

Figure 2: The Fiambond V1 has integrate the Laravel + React, that results manual login, register and forgot password together with Brevo gmail notification. In the FiamBond V2 is become well produce of Sign In With Google, that immediately register and login to the FiamBond's application. The users still manually authentication process, and Firebase integration notify their Gmail Account.

Verify Email Address

<img width="1850" height="915" alt="image" src="https://github.com/user-attachments/assets/2f687257-c503-42fb-8af1-666162e90291" />
...
<img width="1830" height="898" alt="image" src="https://github.com/user-attachments/assets/8b3886ff-5fc6-46b9-b4b9-ed3c3adde285" />
...
Action Buttons (Add a New Transaction)
...
Confirm Funds Confirmed Button

<img width="1832" height="906" alt="image" src="https://github.com/user-attachments/assets/6579a6a2-4792-44e7-bce3-b4df36013b65" />

Confirm Repayment Received Button

<img width="1827" height="907" alt="image" src="https://github.com/user-attachments/assets/03c27090-3790-45ed-878b-2cc75bc5de8d" />
...
<img width="1826" height="907" alt="image" src="https://github.com/user-attachments/assets/7c68f00d-0a3e-4592-80c6-6e5e0965fca9" />
...
<img width="1825" height="908" alt="image" src="https://github.com/user-attachments/assets/04dc3f06-769f-404e-9118-624fc4419c42" />
