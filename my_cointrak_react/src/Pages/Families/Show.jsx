...
export default function Show() {
    ...
    return (
        <>
            {/* The main title remains the same */}
            <h1 className="title">Family Details</h1>

            {family ? (
                <>
                    {/* Add Member Card - Styled exactly like the "Create Family" card */}
                        ...
                        <form onSubmit={handleAddMember} className="space-y-4">
                            <div>
                                <input
                                    ...
                                    // Using the exact same input styling as Index.jsx
                    ...
                    {/* Family Members Card - Styled exactly like the "Your Families" card */}
                        ...
                        {family.members && family.members.length > 0 ? (
                            <div className="space-y-3">
                                {family.members.map((member) => (
                                    <div
                                        key={member.id}
                                        // Using the exact same list item styling as Index.jsx
                            ...
                            // Using the exact same empty state styling as Index.jsx
