...
// --- ICONS (Exact match from Family Dashboard) ---
...
// --- ANALYST SECTION (Styled exactly like Family) ---
const AdminFinancialAnalysis = ({ report }) => {
    const { totalInflow, transactionCount } = report; 
    // totalInflow = Revenue
    // transactionCount = Active Premium Users in this period
    ...
    return (
        <div className="dashboard-section">
            ...
            <div className="dashboard-card p-4 sm:p-6">
                ...
                {/* 3. STAT CARDS GRID (Green, Red, Blue) */}
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-6">
                    
                    {/* Revenue Card (Matches Family Inflow - Green) */}
                    ...
                    {/* Operational Costs (Matches Family Outflow - Red) */}
                    {/* Hardcoded to 0 for now as Admin doesn't track expenses yet, but keeps design consistent */}
                    ...
                    {/* Net Income (Matches Family Net Position - Blue) */}
