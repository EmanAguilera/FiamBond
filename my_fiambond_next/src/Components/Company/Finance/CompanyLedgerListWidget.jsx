...
const TransactionItem = ({ transaction }) => {
    ...
    // Ensure we have a valid Date object (Handling the shimmed object or raw date string)
...
const CompanyLedgerListWidget = ({ transactions, loading }) => {
    ...
    const groupedTransactions = useMemo(() => {
        ...
        return transactions.reduce((acc, transaction) => {
            // Handle both shimmed date objects and raw date strings
            const dateObj = transaction.created_at?.toDate 
                ? transaction.created_at.toDate() 
                : new Date(transaction.created_at || Date.now());
                        ...
                        <div key={dateKey}>
                            ...
                            <div>
                                {groupedTransactions[dateKey].map(transaction => (
                                    // Use 'transaction.id || transaction._id' for MongoDB compatibility
